...
class getDoctrine_UlidGeneratorService extends App_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 5).'/lib/vendor/doctrine/orm/lib/Doctrine/ORM/Id/AbstractIdGenerator.php';
        include_once \dirname(__DIR__, 5).'/lib/vendor/symfony/doctrine-bridge/IdGenerator/UlidGenerator.php';
