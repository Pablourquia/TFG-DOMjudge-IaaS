...
class getManagerRegistryAwareConnectionProviderService extends App_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 5).'/lib/vendor/doctrine/dbal/src/Tools/Console/ConnectionProvider.php';
        include_once \dirname(__DIR__, 5).'/lib/vendor/doctrine/doctrine-bundle/Dbal/ManagerRegistryAwareConnectionProvider.php';
