...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 5).'/lib/vendor/doctrine/cache/lib/Doctrine/Common/Cache/Psr6/DoctrineProvider.php';
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = \Doctrine\Common\Cache\Psr6\CacheAdapter::wrap(\Doctrine\Common\Cache\Psr6\DoctrineProvider::wrap(($this->privates['doctrine.system_cache_pool.traceable'] ?? $this->getDoctrine_SystemCachePool_TraceableService())));
        ...
        $a->setQueryCache($b);
        $a->setResultCache(\Doctrine\Common\Cache\Psr6\CacheAdapter::wrap(\Doctrine\Common\Cache\Psr6\DoctrineProvider::wrap(($this->privates['doctrine.result_cache_pool.traceable'] ?? $this->getDoctrine_ResultCachePool_TraceableService()))));
    ...
    protected function getProfilerDisableListenerService()
    {
        ...
        return $this->privates['App\\EventListener\\ProfilerDisableListener'] = new \App\EventListener\ProfilerDisableListener(($this->services['kernel'] ?? $this->get('kernel', 1)), $a, NULL);
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('p7amm5mPt+', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, false))));
