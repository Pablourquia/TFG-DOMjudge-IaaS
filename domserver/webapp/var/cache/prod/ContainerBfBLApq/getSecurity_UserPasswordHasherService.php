...
class getSecurity_UserPasswordHasherService extends App_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 5).'/lib/vendor/symfony/password-hasher/Hasher/UserPasswordHasherInterface.php';
        include_once \dirname(__DIR__, 5).'/lib/vendor/symfony/password-hasher/Hasher/UserPasswordHasher.php';
