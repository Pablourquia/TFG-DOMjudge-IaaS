...
class getMiscControllerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.MbiTQcK'] ?? $container->load('get_ServiceLocator_MbiTQcKService'))->withContext('App\\Controller\\Team\\MiscController', $container));
