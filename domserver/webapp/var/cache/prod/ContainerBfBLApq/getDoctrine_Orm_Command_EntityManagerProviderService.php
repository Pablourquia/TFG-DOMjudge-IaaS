...
class getDoctrine_Orm_Command_EntityManagerProviderService extends App_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 5).'/lib/vendor/doctrine/orm/lib/Doctrine/ORM/Tools/Console/EntityManagerProvider.php';
        include_once \dirname(__DIR__, 5).'/lib/vendor/doctrine/doctrine-bundle/Orm/ManagerRegistryAwareEntityManagerProvider.php';
