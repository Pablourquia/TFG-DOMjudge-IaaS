...
class getLanguageTypeService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Form\\Type\\LanguageType'])) {
            return $container->privates['App\\Form\\Type\\LanguageType'];
        }

        return $container->privates['App\\Form\\Type\\LanguageType'] = new \App\Form\Type\LanguageType($a);
    }
}
