...
class getNelmioApiDoc_ModelDescribers_ObjectService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/lib/vendor/nelmio/api-doc-bundle/ModelDescriber/ApplyOpenApiDiscriminatorTrait.php';
        include_once \dirname(__DIR__, 5).'/lib/vendor/nelmio/api-doc-bundle/ModelDescriber/ObjectModelDescriber.php';

        return $container->privates['nelmio_api_doc.model_describers.object'] = new \Nelmio\ApiDocBundle\ModelDescriber\ObjectModelDescriber(($container->privates['property_info.cache'] ?? $container->load('getPropertyInfo_CacheService')), ($container->privates['annotations.reader'] ?? $container->getAnnotations_ReaderService()), new RewindableGenerator(function () use ($container) {
