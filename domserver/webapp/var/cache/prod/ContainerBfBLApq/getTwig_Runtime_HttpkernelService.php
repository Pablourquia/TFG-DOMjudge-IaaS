...
class getTwig_Runtime_HttpkernelService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/lib/vendor/symfony/http-kernel/Fragment/FragmentUriGeneratorInterface.php';
        include_once \dirname(__DIR__, 5).'/lib/vendor/symfony/http-kernel/Fragment/FragmentUriGenerator.php';
