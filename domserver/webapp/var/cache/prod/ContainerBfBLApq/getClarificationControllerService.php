 ...
 */
class getClarificationControllerService extends App_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.yDC6bsl'] ?? $container->load('get_ServiceLocator_YDC6bslService'))->withContext('App\\Controller\\API\\ClarificationController', $container));
