...
class OptionsConfig 
{
    ...
    private $tracePropagationTargets;
     ...
     * @return $this
     */
    public function tracePropagationTargets($value): self
    {
        $this->_usedProperties['tracePropagationTargets'] = true;
        $this->tracePropagationTargets = $value;
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('trace_propagation_targets', $value)) {
            $this->_usedProperties['tracePropagationTargets'] = true;
            $this->tracePropagationTargets = $value['trace_propagation_targets'];
            unset($value['trace_propagation_targets']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['tracePropagationTargets'])) {
            $output['trace_propagation_targets'] = $this->tracePropagationTargets;
        }
