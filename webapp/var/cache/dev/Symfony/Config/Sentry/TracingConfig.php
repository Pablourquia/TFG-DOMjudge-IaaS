...
require_once __DIR__.\DIRECTORY_SEPARATOR.'Tracing'.\DIRECTORY_SEPARATOR.'HttpClientConfig.php';
...
class TracingConfig 
{
    ...
    public function httpClient(array $value = []): \Symfony\Config\Sentry\Tracing\HttpClientConfig
    {
        if (null === $this->httpClient) {
            $this->_usedProperties['httpClient'] = true;
            $this->httpClient = new \Symfony\Config\Sentry\Tracing\HttpClientConfig($value);
        } elseif (0 < \func_num_args()) {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('http_client', $value)) {
            $this->_usedProperties['httpClient'] = true;
            $this->httpClient = new \Symfony\Config\Sentry\Tracing\HttpClientConfig($value['http_client']);
