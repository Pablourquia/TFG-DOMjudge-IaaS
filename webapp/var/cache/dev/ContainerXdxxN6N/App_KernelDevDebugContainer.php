...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\API\\AccessController' => 'getAccessControllerService',
            ...
            'App\\Controller\\Jury\\CreateQuizController' => 'getCreateQuizControllerService',
            'App\\Controller\\Jury\\ExecutableController' => 'getExecutableController2Service',
            'App\\Controller\\Jury\\ExternalContestController' => 'getExternalContestControllerService',
            ...
            'console.command.public_alias.App\\Command\\CallApiActionCommand' => 'getCallApiActionCommandService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 5).'/lib/vendor/doctrine/doctrine-bundle/Dbal/SchemaAssetsFilterManager.php';
            include_once \dirname(__DIR__, 5).'/lib/vendor/doctrine/doctrine-bundle/Dbal/RegexSchemaAssetFilter.php';
            include_once \dirname(__DIR__, 5).'/lib/vendor/doctrine/dbal/src/Driver/Middleware.php';
            include_once \dirname(__DIR__, 5).'/lib/vendor/doctrine/dbal/src/Logging/Middleware.php';
            ...
            include_once \dirname(__DIR__, 5).'/lib/vendor/doctrine/doctrine-bundle/Middleware/ConnectionNameAwareInterface.php';
            include_once \dirname(__DIR__, 5).'/lib/vendor/doctrine/doctrine-bundle/Middleware/DebugMiddleware.php';
            ...
            include_once \dirname(__DIR__, 5).'/lib/vendor/doctrine/event-manager/src/EventManager.php';
            ...
            include_once \dirname(__DIR__, 5).'/lib/vendor/symfony/doctrine-bridge/Middleware/Debug/DebugDataHolder.php';
            include_once \dirname(__DIR__, 5).'/lib/vendor/doctrine/doctrine-bundle/Middleware/BacktraceDebugDataHolder.php';
            ...
            include_once \dirname(__DIR__, 5).'/lib/vendor/doctrine/common/src/Proxy/Autoloader.php';
            ...
            include_once \dirname(__DIR__, 5).'/lib/vendor/jms/serializer-bundle/Debug/RunsListener.php';
            ...
            include_once \dirname(__DIR__, 5).'/lib/vendor/jms/serializer-bundle/Debug/TraceableMetadataFactory.php';
            ...
            include_once \dirname(__DIR__, 5).'/lib/vendor/jms/serializer-bundle/Debug/TraceableFileLocator.php';
            include_once \dirname(__DIR__, 5).'/lib/vendor/jms/metadata/src/Driver/TraceableFileLocatorInterface.php';
            ...
            include_once \dirname(__DIR__, 5).'/lib/vendor/sentry/sentry-symfony/src/Tracing/Cache/TraceableCacheAdapterForV3.php';
            ...
            include_once \dirname(__DIR__, 5).'/lib/vendor/jms/serializer-bundle/Debug/DataCollector.php';
            ...
            include_once \dirname(__DIR__, 5).'/lib/vendor/twig/extra-bundle/MissingExtensionSuggestor.php';
    ...
    protected function get_Container_Private_TwigService()
    {
        ...
        $a->addPath((\dirname(__DIR__, 5).'/lib/vendor/symfony/security-bundle/Resources/views'), '!Security');
        $a->addPath((\dirname(__DIR__, 5).'/lib/vendor/symfony/web-profiler-bundle/Resources/views'), 'WebProfiler');
        $a->addPath((\dirname(__DIR__, 5).'/lib/vendor/symfony/web-profiler-bundle/Resources/views'), '!WebProfiler');
        $a->addPath((\dirname(__DIR__, 5).'/lib/vendor/doctrine/doctrine-migrations-bundle/Resources/views'), 'DoctrineMigrations');
        $a->addPath((\dirname(__DIR__, 5).'/lib/vendor/doctrine/doctrine-migrations-bundle/Resources/views'), '!DoctrineMigrations');
        $a->addPath((\dirname(__DIR__, 5).'/lib/vendor/symfony/debug-bundle/Resources/views'), 'Debug');
        $a->addPath((\dirname(__DIR__, 5).'/lib/vendor/symfony/debug-bundle/Resources/views'), '!Debug');
        ...
        $e = new \Symfony\Bridge\Twig\Extension\AssetExtension(new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('v=8.2.3', '%s?%s'), new \Symfony\Component\Asset\Context\RequestStackContext($c, $d->getBaseUrl(), $d->isSecure())), new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0)));
        $f = ($this->privates['debug.file_link_formatter'] ?? $this->getDebug_FileLinkFormatterService());
        $g = ($this->services['.container.private.security.authorization_checker'] ?? $this->get_Container_Private_Security_AuthorizationCheckerService());
        ...
        $j = ($this->privates['Sentry\\State\\HubInterface'] ?? $this->getHubInterfaceService());
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\SecurityExtension($g, new \Symfony\Component\Security\Http\Impersonate\ImpersonateUrlGenerator($c, ($this->privates['security.firewall.map'] ?? $this->getSecurity_Firewall_MapService()), $h)));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\DumpExtension(($this->services['var_dumper.cloner'] ?? $this->getVarDumper_ClonerService()), ($this->privates['var_dumper.html_dumper'] ?? $this->getVarDumper_HtmlDumperService())));
        $instance->addExtension(new \App\Twig\TwigExtension(($this->privates['App\\Service\\DOMJudgeService'] ?? $this->getDOMJudgeServiceService()), ($this->services['App\\Service\\ConfigurationService'] ?? $this->getConfigurationServiceService()), $instance, ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Service\\SubmissionService'] ?? $this->getSubmissionServiceService()), ($this->privates['App\\Service\\EventLogService'] ?? $this->getEventLogServiceService()), ($this->privates['App\\Service\\AwardService'] ?? $this->getAwardServiceService()), $h, $g, \dirname(__DIR__, 4)));
        ...
        $instance->addExtension(new \Sentry\SentryBundle\Tracing\Twig\TwigTracingExtension($j));
        $instance->addExtension(new \Sentry\SentryBundle\Twig\SentryExtension($j));
        ...
        $instance->addGlobal('DOMJUDGE_VERSION', '8.2.3');
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('6tT92u51uL', 0, ($this->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(new \Sentry\SentryBundle\Tracing\Cache\TraceableCacheAdapter(($this->privates['Sentry\\State\\HubInterface'] ?? $this->getHubInterfaceService()), \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EP+Xl4eytX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()))));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c = new \Doctrine\Bundle\DoctrineBundle\Middleware\DebugMiddleware(($this->privates['doctrine.debug_data_holder'] ?? ($this->privates['doctrine.debug_data_holder'] = new \Doctrine\Bundle\DoctrineBundle\Middleware\BacktraceDebugDataHolder($this->parameters['nelmio_api_doc.areas']))), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
        $c->setConnectionName('default');

        $a->setSchemaAssetsFilter(new \Doctrine\Bundle\DoctrineBundle\Dbal\SchemaAssetsFilterManager([0 => new \Doctrine\Bundle\DoctrineBundle\Dbal\RegexSchemaAssetFilter('~^(?!sessions)~')]));
        $a->setMiddlewares([0 => new \Doctrine\DBAL\Logging\Middleware($b), 1 => $c, 2 => new \Sentry\SentryBundle\Tracing\Doctrine\DBAL\TracingDriverMiddleware(new \Sentry\SentryBundle\Tracing\Doctrine\DBAL\TracingDriverConnectionFactory(($this->privates['Sentry\\State\\HubInterface'] ?? $this->getHubInterfaceService())))]);
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.response', [0 => function () {
            return ($this->privates['App\\EventListener\\AddContentSecurityPolicyListener'] ?? $this->getAddContentSecurityPolicyListenerService());
        }, 1 => 'onKernelResponse'], 0);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    /**
     * Gets the private 'App\EventListener\AddContentSecurityPolicyListener' shared autowired service.
     *
     * @return \App\EventListener\AddContentSecurityPolicyListener
     */
    protected function getAddContentSecurityPolicyListenerService()
    {
        $a = ($this->services['.container.private.profiler'] ?? $this->get_Container_Private_ProfilerService());

        if (isset($this->privates['App\\EventListener\\AddContentSecurityPolicyListener'])) {
            return $this->privates['App\\EventListener\\AddContentSecurityPolicyListener'];
        }

        return $this->privates['App\\EventListener\\AddContentSecurityPolicyListener'] = new \App\EventListener\AddContentSecurityPolicyListener($a);
    }
    ...
    protected function getAddCurrentContestListenerService()
    {
        ...
        if (isset($this->privates['App\\EventListener\\AddCurrentContestListener'])) {
            return $this->privates['App\\EventListener\\AddCurrentContestListener'];
        }

        return $this->privates['App\\EventListener\\AddCurrentContestListener'] = new \App\EventListener\AddCurrentContestListener($a);
    }
    ...
    protected function getProfilerDisableListenerService()
    {
        ...
        if (isset($this->privates['App\\EventListener\\ProfilerDisableListener'])) {
            return $this->privates['App\\EventListener\\ProfilerDisableListener'];
        }
        $b = ($this->services['.container.private.profiler'] ?? $this->get_Container_Private_ProfilerService());

        if (isset($this->privates['App\\EventListener\\ProfilerDisableListener'])) {
            return $this->privates['App\\EventListener\\ProfilerDisableListener'];
        }

        return $this->privates['App\\EventListener\\ProfilerDisableListener'] = new \App\EventListener\ProfilerDisableListener(($this->services['kernel'] ?? $this->get('kernel', 1)), $a, $b);
    }
     ...
     */
    protected function getAwardServiceService()
    {
        $a = ($this->privates['App\\Service\\EventLogService'] ?? $this->getEventLogServiceService());

        if (isset($this->privates['App\\Service\\AwardService'])) {
            return $this->privates['App\\Service\\AwardService'];
        }

        return $this->privates['App\\Service\\AwardService'] = new \App\Service\AwardService($a);
    }
    ...
    protected function getDOMJudgeServiceService()
    {
        ...
        if (isset($this->privates['App\\Service\\DOMJudgeService'])) {
            return $this->privates['App\\Service\\DOMJudgeService'];
        }
    ...
    protected function getEventLogServiceService()
    {
        ...
        if (isset($this->privates['App\\Service\\EventLogService'])) {
            return $this->privates['App\\Service\\EventLogService'];
        }

        return $this->privates['App\\Service\\EventLogService'] = new \App\Service\EventLogService($a, ($this->services['App\\Service\\ConfigurationService'] ?? $this->getConfigurationServiceService()), ($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()));
    }
    ...
    protected function getScoreboardServiceService()
    {
        ...
        if (isset($this->privates['App\\Service\\ScoreboardService'])) {
            return $this->privates['App\\Service\\ScoreboardService'];
        }
        $b = ($this->privates['App\\Service\\EventLogService'] ?? $this->getEventLogServiceService());
    ...
    protected function getSubmissionServiceService()
    {
        ...
        if (isset($this->privates['App\\Service\\SubmissionService'])) {
            return $this->privates['App\\Service\\SubmissionService'];
        }
        $b = ($this->privates['App\\Service\\EventLogService'] ?? $this->getEventLogServiceService());
        ...
        $c = ($this->privates['App\\Service\\ScoreboardService'] ?? $this->getScoreboardServiceService());

        if (isset($this->privates['App\\Service\\SubmissionService'])) {
            return $this->privates['App\\Service\\SubmissionService'];
        }

        return $this->privates['App\\Service\\SubmissionService'] = new \App\Service\SubmissionService(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['monolog.logger'] ?? $this->getMonolog_LoggerService()), $a, ($this->services['App\\Service\\ConfigurationService'] ?? $this->getConfigurationServiceService()), $b, $c);
    }
    ...
    {
        return $this->privates['cache.property_info.traceable'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(new \Sentry\SentryBundle\Tracing\Cache\TraceableCacheAdapter(($this->privates['Sentry\\State\\HubInterface'] ?? $this->getHubInterfaceService()), \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('8QHalks6Jf', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()))));
    }
    ...
    {
        return $this->privates['cache.serializer.traceable'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(new \Sentry\SentryBundle\Tracing\Cache\TraceableCacheAdapter(($this->privates['Sentry\\State\\HubInterface'] ?? $this->getHubInterfaceService()), \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ayUnCeIKGE', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()))));
    }
    ...
    {
        return $this->privates['cache.validator.traceable'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(new \Sentry\SentryBundle\Tracing\Cache\TraceableCacheAdapter(($this->privates['Sentry\\State\\HubInterface'] ?? $this->getHubInterfaceService()), \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0cOkWdGDcy', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()))));
    }
    ...
    protected function getJmsSerializer_EventDispatcherService()
    {
        ...
        $instance->addListener('serializer.post_serialize', [0 => 'App\\Serializer\\ContestProblemVisitor', 1 => 'onPostSerialize'], 'App\\Entity\\ContestProblem', 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'App\\Serializer\\ContestVisitor', 1 => 'onPostSerialize'], 'App\\Entity\\Contest', 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'App\\Serializer\\SetExternalIdVisitor', 1 => 'onPostSerialize'], NULL, 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'App\\Serializer\\SubmissionVisitor', 1 => 'onPostSerialize'], 'App\\Entity\\Submission', 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'App\\Serializer\\TeamAffiliationVisitor', 1 => 'onPostSerialize'], 'App\\Entity\\TeamAffiliation', 'json', NULL);
        $instance->addListener('serializer.post_serialize', [0 => 'App\\Serializer\\TeamVisitor', 1 => 'onPostSerialize'], 'App\\Entity\\Team', 'json', NULL);
    ...
    {
        $a = ($this->privates['.service_locator.LlG0ewc'] ?? $this->get_ServiceLocator_LlG0ewcService());
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'console.command.ids' => [
                0 => 'console.command.public_alias.App\\Command\\CallApiActionCommand',
                1 => 'console.command.public_alias.App\\Command\\CheckDatabaseConfigurationDefaultValuesCommand',
                2 => 'console.command.public_alias.App\\Command\\ImportEventFeedCommand',
                3 => 'console.command.public_alias.App\\Command\\LoadDefaultDataCommand',
                4 => 'console.command.public_alias.App\\Command\\LoadDevelopmentDataCommand',
                5 => 'console.command.public_alias.App\\Command\\LoadExampleDataCommand',
                6 => 'console.command.public_alias.App\\Command\\LoadGatlingDataCommand',
                7 => 'console.command.public_alias.App\\Command\\ResetUserPasswordCommand',
                8 => 'console.command.public_alias.App\\Command\\ScoreboardMergeCommand',
            ],
        ];
    }
