...
class getNelmioApiDoc_Describers_OpenapiPhp_DefaultService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 5).'/lib/vendor/nelmio/api-doc-bundle/Util/SetsContextTrait.php';
        include_once \dirname(__DIR__, 5).'/lib/vendor/nelmio/api-doc-bundle/Describer/OpenApiPhpDescriber.php';
